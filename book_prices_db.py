...
class BookPricesDatabase():
    ...
    def __init__(self, book_prices_db_path):
        
        # BookDatabase
        self.book_db = BookDatabase(book_db_path)
        ...
        self.waiting_time_between_buckets = 1200
    ...
    def calculate_average_last_week(self, id):
        ...
        prices_last_week = prices[-7: ]
        
        # TODO: find more elegant way to deal with no entries in prices
        average_price_last_week = np.nan
        
        if prices_last_week.any():
            average_price_last_week = prices_last_week.mean().round(2)
...
#book_prices_db.add_variable_to_db('deal')
...
#book_prices_db.calculate_average_last_week('')
